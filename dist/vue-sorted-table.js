...
// CONCATENATED MODULE: ./src/components/SortedTable.vue?vue&type=template&id=5d8cc543&
  ...
  computed: {
    sortedValues: function sortedValues() {
      return this.values.slice().sort(function (a, b) {
        ...
        if (this.$_.get(a, this.currentSort) < this.$_.get(b, this.currentSort)) {
          return -1 * modifier;
        }
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"cffca526-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/SortLink.vue?vue&type=template&id=58d827cd&
var SortLinkvue_type_template_id_58d827cd_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('a',{attrs:{"href":"#"},on:{"click":function($event){$event.preventDefault();_vm.$parent.sortBy(_vm.name)}}},[_vm._t("default"),(_vm.$parent.getCurrentSort() == _vm.name)?_c('span',{domProps:{"innerHTML":_vm._s(_vm.$parent.getSortIcon())}}):_vm._e()],2)}
var SortLinkvue_type_template_id_58d827cd_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/SortLink.vue?vue&type=template&id=58d827cd&
...
var SortLink_component = normalizeComponent(
  ...
  SortLinkvue_type_template_id_58d827cd_render,
  SortLinkvue_type_template_id_58d827cd_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./src/plugin.js?shadow


var pluginshadow_plugin = {
  install: (Vue, config) => {
...
SortedTable.install = pluginshadow_plugin.install;
/* harmony default export */ var pluginshadow = (SortedTable);
...
window.customElements.define('vue-sorted-table', vue_wc_wrapper(external_Vue_default.a, pluginshadow))
...
/******/ });
//# sourceMappingURL=vue-sorted-table.js.map